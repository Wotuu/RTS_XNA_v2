...
namespace MapEditor
{
    ...
    /// or disposed.
    /// </summary>
    class GraphicsDeviceServiceMiniMap : IGraphicsDeviceService
    {
        #region Fields


        // Singleton device service instance.
        static GraphicsDeviceServiceMiniMap singletonInstance;
        ...
        /// </summary>
        GraphicsDeviceServiceMiniMap(IntPtr windowHandle, int width, int height)
        {
