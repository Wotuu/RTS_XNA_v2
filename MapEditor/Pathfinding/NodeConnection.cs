...
namespace MapEditor.Pathfinding
{
    public class DrawableNodeConnection
    {
        ...
        internal void Draw(SpriteBatch sb)
        {
            ...
            drawutil.DrawLine(sb, new Point(node1Location.X - (int)Form1.camera.Position.X, node1Location.Y - (int)Form1.camera.Position.Y),
                new Point(node2Location.X - (int)Form1.camera.Position.X, node2Location.Y - (int)Form1.camera.Position.Y), 
                this.drawColor, 1, Form1.linetexture);
